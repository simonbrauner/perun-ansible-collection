...
class OwnerType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """OwnerType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): enumeration of types of Owners., must be one of ["technical", "administrative", ]  # noqa: E501

        Keyword Args:
            value (str): enumeration of types of Owners., must be one of ["technical", "administrative", ]  # noqa: E501
