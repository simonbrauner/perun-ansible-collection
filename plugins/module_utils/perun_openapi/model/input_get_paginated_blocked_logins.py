...
def lazy_import():
    ...
    globals()['BlockedLoginsPageQuery'] = BlockedLoginsPageQuery


class InputGetPaginatedBlockedLogins(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'query': (BlockedLoginsPageQuery,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, query, *args, **kwargs):  # noqa: E501
        """InputGetPaginatedBlockedLogins - a model defined in OpenAPI
