...
class GraphFileFormat(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """GraphFileFormat - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): currently supported formats are DOT and TGF., must be one of ["DOT", "TGF", ]  # noqa: E501

        Keyword Args:
            value (str): currently supported formats are DOT and TGF., must be one of ["DOT", "TGF", ]  # noqa: E501
