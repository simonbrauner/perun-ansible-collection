...
class RoleAssignmentType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """RoleAssignmentType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): type of role assignment., must be one of ["DIRECT", "INDIRECT", ]  # noqa: E501

        Keyword Args:
            value (str): type of role assignment., must be one of ["DIRECT", "INDIRECT", ]  # noqa: E501
