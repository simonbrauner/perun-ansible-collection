...
class InputSendMessages(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, mail_type, ids, *args, **kwargs):  # noqa: E501
        """InputSendMessages - a model defined in OpenAPI

        Args:
            mail_type (MailType):
            ids ([int]): An array of integers representing the IDs of applications
    ...
    @convert_js_args_to_python_args
    def __init__(self, mail_type, ids, *args, **kwargs):  # noqa: E501
        """InputSendMessages - a model defined in OpenAPI
