...
class GroupAdminRoles(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """GroupAdminRoles - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): admin roles for a group., must be one of ["GROUPOBSERVER", "GROUPMEMBERSHIPMANAGER", "GROUPADMIN", ]  # noqa: E501

        Keyword Args:
            value (str): admin roles for a group., must be one of ["GROUPOBSERVER", "GROUPMEMBERSHIPMANAGER", "GROUPADMIN", ]  # noqa: E501
