...
class InputCheckPasswordStrength(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, password, namespace, *args, **kwargs):  # noqa: E501
        """InputCheckPasswordStrength - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, password, namespace, *args, **kwargs):  # noqa: E501
        """InputCheckPasswordStrength - a model defined in OpenAPI
