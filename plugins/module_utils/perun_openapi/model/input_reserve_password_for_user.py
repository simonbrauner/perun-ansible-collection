...
class InputReservePasswordForUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, namespace, password, *args, **kwargs):  # noqa: E501
        """InputReservePasswordForUser - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, namespace, password, *args, **kwargs):  # noqa: E501
        """InputReservePasswordForUser - a model defined in OpenAPI
