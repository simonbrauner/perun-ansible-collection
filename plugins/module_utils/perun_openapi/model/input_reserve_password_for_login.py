...
class InputReservePasswordForLogin(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, login, namespace, password, *args, **kwargs):  # noqa: E501
        """InputReservePasswordForLogin - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, login, namespace, password, *args, **kwargs):  # noqa: E501
        """InputReservePasswordForLogin - a model defined in OpenAPI
