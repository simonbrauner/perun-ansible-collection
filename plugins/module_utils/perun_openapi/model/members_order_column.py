...
class MembersOrderColumn(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["ID", "NAME", "EMAIL", "GROUP_STATUS", "STATUS", "ORGANIZATION", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["ID", "NAME", "EMAIL", "GROUP_STATUS", "STATUS", "ORGANIZATION", ]  # noqa: E501
