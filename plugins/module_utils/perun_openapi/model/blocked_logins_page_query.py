...
class BlockedLoginsPageQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sort_column': (BlockedLoginsOrderColumn,),  # noqa: E501
    ...
    def _from_openapi_data(cls, page_size, offset, order, sort_column, *args, **kwargs):  # noqa: E501
        """BlockedLoginsPageQuery - a model defined in OpenAPI

        Args:
            page_size (int):
            offset (int):
            order (SortingOrder):
            sort_column (BlockedLoginsOrderColumn):
