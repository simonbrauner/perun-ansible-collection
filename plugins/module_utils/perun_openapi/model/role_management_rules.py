...
class RoleManagementRules(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'privileged_roles_to_manage': ([{str: (str, none_type)}],),  # noqa: E501
            'privileged_roles_to_read': ([{str: (str, none_type)}],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, role_name, primary_object, privileged_roles_to_manage, privileged_roles_to_read, entities_to_manage, assigned_objects, assignable_to_attributes, display_name, *args, **kwargs):  # noqa: E501
        """RoleManagementRules - a model defined in OpenAPI

        Args:
            role_name (str):
            primary_object (str, none_type):
            privileged_roles_to_manage ([{str: (str, none_type)}]):
            privileged_roles_to_read ([{str: (str, none_type)}]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, role_name, primary_object, privileged_roles_to_manage, privileged_roles_to_read, entities_to_manage, assigned_objects, assignable_to_attributes, display_name, *args, **kwargs):  # noqa: E501
        """RoleManagementRules - a model defined in OpenAPI
